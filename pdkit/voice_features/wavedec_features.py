...
def compute_wavedec_features(data, wname='db8', dec_levels=10, mode='symmetric'):
    ...
    C, L = wavedec_matlab(data, wname, dec_levels)
    energy = w_energy_matlab(C, L)
    ...
    log_C, log_L = wavedec_matlab(log_data, wname, dec_levels)

    log_energy = w_energy_matlab(log_C, log_L)
