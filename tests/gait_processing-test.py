...
class GaitProcessingTest(unittest.TestCase):
    def setUp(self):
        ...
        self.step_regularity = round_to_two([0.44895787870999526, 0.27681789027394327, 0.42835833214314395])
        self.stride_regularity = round_to_two([0.7247920086474582, 0.639939599082686, 0.33527723619800587])
        self.walk_symmetry = round_to_two([0.2758341299374629, 0.3631217088087428, -0.09308109594513808])
    ...
    def test_freeze_of_gait(self):
        ...
        self.assertEqual(round_to_two(freeze_times), self.freeze_times)
    ...
    def test_walk_regularity_symmetry(self):
        ...
        self.assertEqual(round_to_two(step_regularity), self.step_regularity)
        self.assertEqual(round_to_two(stride_regularity), self.stride_regularity)
        self.assertEqual(round_to_two(walk_symmetry), self.walk_symmetry)
